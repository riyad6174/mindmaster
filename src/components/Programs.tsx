...
const programs = [
  {
    ...
    description:
      'Nurturing curiosity through project-based learning and foundational literacy.',
  ...
  },
  {
    ...
    description:
      'Building critical thinking and social-emotional skills in a digital-first environment.',
    btnBg: 'bg-[#fcdf46] text-[#483d00]',
    image:
  ...
  },
  {
    ...
    description:
      'Advanced placement and career counseling for university readiness and beyond.',
    btnBg: 'bg-[#fcdf46] text-[#483d00]',
    image:
